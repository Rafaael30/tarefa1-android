package tarefa1.fatesg.senai.com.tarefa1.activitys;
...
import tarefa1.fatesg.senai.com.tarefa1.R;
...
public class MainActivity extends DebugActivity {
    ...
    public void add(View view){
        ...
        int[] to={R.id.txt_id,R.id.txt_cliente,R.id.txt_data,R.id.txt_produtos,R.id.txt_valor};
